...
class _ForgetScreenState extends State<ForgetScreen> {
  ...
  Widget signInTextRow() {
    return Container(
      margin: EdgeInsets.only(left: _width / 19.0),
      child: Row(
        children: <Widget>[
          Text(
            "Give registered Email address,we'll send link ",
            style: TextStyle(
               color:Colors.black,
              fontWeight: FontWeight.w200,
              fontSize: _large? 20 : (_medium? 14.5 : 15),
            ),
          ),
        ],
      ),
  ...
  Widget button() {
    return RaisedButton(
      ...
      child: Container(
        ...
        child: Text('Send',style: TextStyle(fontSize: _large? 14: (_medium? 19: 10))),
      ),
    );
  }
