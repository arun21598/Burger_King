...
class _HotelInfoState extends State<HotelInfo> {
  ...
  Widget build(BuildContext context) {
      ...
      child: ListView(
        ...
        children: <Widget>[
          Container(
              ...
              child: ClipRRect(
                child: new Image(image: AssetImage("assets/images/food1.jpg")),
                borderRadius: BorderRadius.all(Radius.circular(8.0)),
              )),
          Container(
              height: MediaQuery.of(context).size.width * 0.4,
              ...
              child: ClipRRect(
                child: new Image(image: AssetImage("assets/images/3.png")),
                borderRadius: BorderRadius.all(Radius.circular(8.0)),
              )),
          Container(
              height: MediaQuery.of(context).size.width * 0.4,
              ...
              child: ClipRRect(
                child: new Image(image: AssetImage("assets/images/food3.jpg")),
                borderRadius: BorderRadius.all(Radius.circular(8.0)),
              )),
        ],
      ),
    ...
    return new Scaffold(
      ...
      // child:Column(
        children: <Widget>[
          new Image(image: AssetImage("assets/images/banner.jpg")),
          Positioned(
